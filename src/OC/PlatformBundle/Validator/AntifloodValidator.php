...
Class AntifloodValidator extends ConstraintValidator
{
	...
	// Les arguments déclarés ds la def du service arrivent au constructeur
	// On doit les enregistrer ds l'objet pour pouvoir s'en resservir ds la méthode validate()
	...
	public function validate($value, Constraint $constraint)
	{
		...
		// On vérifie si cette IP a déjà posté une candidature il y a moins de 15 sec
		$isFlood = $this->em
